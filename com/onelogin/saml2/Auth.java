...
public class Auth {
	...
	public Auth() throws IOException, SettingsException, Error {
		this(new SettingsBuilder().fromFile("../conf/onelogin.saml.properties").build(), null, null);
	}
	...
	public Auth(HttpRequest request, HttpResponse response) throws IOException, SettingsException, Error {
		this(new SettingsBuilder().fromFile("../conf/onelogin.saml.properties").build(), request, response);
	}
	...
	public String logout(String returnTo, String nameId, String sessionIndex, Boolean stay, String nameidFormat) throws IOException, XMLEntityException, SettingsException {
		...
		lastRequestId = logoutRequest.getIdLogout();
	...
	public void processSLO(Boolean keepLocalSession, String requestId) throws Exception {
		...
		if (samlResponseParameter != null) {
			...
			if (!logoutRequest.isValid()) {
				...
				lastMessageId = logoutRequest.getIdLogout();
